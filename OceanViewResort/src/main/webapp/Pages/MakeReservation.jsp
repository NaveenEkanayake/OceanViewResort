...
<head>
    ...
    <title>Ocean Resort - Make Reservation</title>
    ...
    <link rel="stylesheet" href="../StyleSheets/Css/UpdateReservation.css">
        ...
        <div class="container d-flex justify-content-center reservation-container">
            <div class="col-12 col-md-8 col-lg-6 animate__animated animate__fadeInUp">
                <div class="glass-form">
                    <h2 class="text-center mb-4"><i class="fa-solid fa-hotel me-2"></i> Reservation Form</h2>
                    ...
                    <form id="resForm" action="../submitReservation" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text" class="form-control" name="address" placeholder="123 Ocean Street" required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                ...
                                <input type="tel" class="form-control" name="contactNumber" placeholder="+94 77 123 4567" required>
                            </div>
                        </div>
