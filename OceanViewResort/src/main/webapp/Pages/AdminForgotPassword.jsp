...
<head>
    ...
    <title>Admin Forgot Password - Ocean View Resort</title>
    
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css" rel="stylesheet">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/animate.css/4.1.1/animate.min.css"/>
    <link rel="stylesheet" href="${pageContext.request.contextPath}/StyleSheets/Css/AdminForgotPassword.css">
</head>
<body class="admin-forgot-password-body">
    <!-- Toast Container -->
    <div class="toast-container position-fixed top-0 end-0 p-3" style="z-index: 2000;">
        <div id="adminForgotPasswordToast" class="toast align-items-center text-white border-0 shadow-lg">
            <div class="d-flex">
    ...
    <div class="form-section active" id="emailSection">
        <div class="forgot-card animate__animated animate__fadeInUp">
            ...
            <form id="emailForm" onsubmit="submitEmail(event)">
                ...
                <button type="submit" class="btn btn-admin w-100 py-2 fw-bold" id="sendCodeBtn">
            ...
            <div class="text-center mt-3">
                <a href="AdminLogin.jsp" class="text-admin-link">
    ...
    <div class="form-section" id="otpSection">
        <div class="forgot-card animate__animated animate__fadeInUp">
            ...
            <form id="otpForm" onsubmit="verifyOTP(event)">
                ...
                <button type="submit" class="btn btn-admin w-100 py-2 fw-bold" id="verifyOtpBtn">
            ...
            <div class="text-center mt-3">
                <button type="button" class="btn btn-link text-admin-link" onclick="resendCode()">
    ...
    <div class="form-section" id="resetSection">
        <div class="forgot-card animate__animated animate__fadeInUp">
            ...
            <form id="resetForm" onsubmit="resetPassword(event)">
                ...
                <button type="submit" class="btn btn-admin w-100 py-2 fw-bold" id="resetPasswordBtn">
    ...
    <script src="${pageContext.request.contextPath}/StyleSheets/Js/AdminForgotPassword.js"></script>
</body>
</html>
